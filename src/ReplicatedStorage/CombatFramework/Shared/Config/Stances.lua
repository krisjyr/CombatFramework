...
local Stances: { [string]: StanceDefinition } = {
	...
	TacticalWalk = {
		...
		CanLean = true,
		TransitionTime = 0.1,
		AllowedTransitions = { "Standing", "Crouching", "Prone", "TacticalSprint", "Jumping" },
		Animations = { Idle = "rbxassetid://0", Move = "rbxassetid://0" },
	},
	...
	Crouching = {
		...
		CanLean = true,
		TransitionTime = 0.25,
		AllowedTransitions = { "Standing", "TacticalWalk", "Prone", "Jumping" },
		Animations = { Idle = "rbxassetid://0", Move = "rbxassetid://0" },
	},
	...
	TacticalSprint = {
		...
		CanLean = false,
		TransitionTime = 0.2,
		AllowedTransitions = { "Standing", "TacticalWalk", "Jumping" },
		Animations = { Idle = "rbxassetid://0", Move = "rbxassetid://0" },
	},
